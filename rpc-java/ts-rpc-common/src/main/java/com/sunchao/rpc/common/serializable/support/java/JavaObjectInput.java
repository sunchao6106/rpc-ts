...
import com.sunchao.rpc.common.serializable.support.nativejava.NativeJavaObjectInput;
...
public class JavaObjectInput extends NativeJavaObjectInput {
	...
	public <T> T readObject(Class<T> cls) throws ClassNotFoundException,
	        IOException {
		return (T) readObject();
	}
	
	@SuppressWarnings("unchecked")
	public <T> T readObject(Class<T> cls, Type type) throws ClassNotFoundException,
	        IOException {
		return (T) readObject();
	}
